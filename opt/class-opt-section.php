 ...
 * @access public
 */
if(!class_exists('_Proton__Opt_Section')):

class _Proton__Opt_Section {
	...
	public function is_active() {
		...
		return apply_filters( 'proton_opt_is_section_active', $is_active, $this );
	}
	...
	public function print_template() { ?>
		...
		<script type="text/html" id="tmpl-proton-opt-section-<?php echo esc_attr( $this->type ); ?>">
	...
	public function get_template() {
		...
		proton_get_template('section', $this->type );
	}
}
endif;