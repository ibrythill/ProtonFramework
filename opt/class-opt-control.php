 ...
 * @access public
 */
if(!class_exists('_Proton__Opt_Control')):

class _Proton__Opt_Control {
	...
	public function get_field_name( $setting = 'default' ) {
		if('menu' == $this->manager->type){
			return "proton_opt_{$this->manager->name}_setting_{$this->settings[ $setting ]}_{$this->manager->post_id}";
		}else{
			return "proton_opt_{$this->manager->name}_setting_{$this->settings[ $setting ]}";
		}
	...
	public function is_active() {
		...
		return apply_filters( 'proton_opt_is_control_active', $is_active, $this );
	}
	...
	public function print_template() { ?>
		...
		<script type="text/html" id="tmpl-proton-opt-control-<?php echo esc_attr( $this->type ); ?>">
	...
	public function get_template() {
		...
		proton_get_template('control', $this->type );
	}
}
endif;